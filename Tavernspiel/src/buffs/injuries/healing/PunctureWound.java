 ...
 */
public class PunctureWound extends HealingInjury{
    ...
    public PunctureWound(Description desc, double[] p, int lvl){
        super("Puncture Wound", desc, p);
        level = lvl;
    }
    
    public PunctureWound(){
        super("Puncture Wound");
    }

    @Override
    public HealingInjury downgradeInjury(){
        PunctureWound av = new PunctureWound();
        av.setLevel(level-1);
        return av;
    }
