 ...
 */
public class Laceration extends HealingInjury{
    ...
    public Laceration(Description desc, double[] p, int lvl){
        super("Laceration", desc, p);
        level = lvl;
    }
    ...
    public void setLevel(int lvl){
        ...
        evLoss = getGaussianAboveZero(0.3*level, 0.4);
