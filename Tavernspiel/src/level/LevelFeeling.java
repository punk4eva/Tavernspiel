...
public final class LevelFeeling{
    ...
    public static final LevelFeeling STANDARD = new LevelFeeling(null,
            "Cyanoshrooms.wav",
            new Distribution(new int[]{20,11,13,3,1,5,6,13,10,4,2,3,3,1,2}), 
    ...
    public static final LevelFeeling GRASS = new LevelFeeling(
            ...
            new Distribution(new int[]{16,8,12,6,1,6,7,11,12,8,3,4,4,2,3}), 
    ...
    public static final LevelFeeling WATER = new LevelFeeling(
            ...
            new Distribution(new int[]{22,12,12,1,1,4,5,14,8,2,3,2,2,1,1}), 
    ...
    public static final LevelFeeling BURIED_CITY = new LevelFeeling(
            ...
            "Cyanoshrooms.wav",
            new Distribution(new int[]{13,6,4,6,2,8,11,20,12,5,6,9,9,3,5}), 
    ...
    public static final LevelFeeling BURNED = new LevelFeeling(
            ...
            new Distribution(new int[]{21,12,15,1,1,5,3,13,13,12,1,1,1,1,2}), 
