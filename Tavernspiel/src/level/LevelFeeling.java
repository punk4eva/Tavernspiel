...
public class LevelFeeling{
    ...
    public LevelFeeling(String desc, String bgp, Distribution room, Distribution itRoom,
            ...
            Distribution gC, Distribution guc, boolean wbg, int dif, int vis, List<MakeRoom>... fRooms){
        description = desc;
        roomDist = room;
        itemRoomDist = itRoom;
    ...
    public static final LevelFeeling STANDARD = new LevelFeeling(null,
            ...
            new Distribution(1, 25), new Distribution(1, 2), true, 1, 6);
    public static final LevelFeeling GRASS = new LevelFeeling(
            ...
            new Distribution(1, 16), new Distribution(6, 11), false, 1, 5);
    public static final LevelFeeling WATER = new LevelFeeling(
            ...
            new Distribution(1, 28), new Distribution(1, 3), true, 1, 6);
    public static final LevelFeeling BURIED_CITY = new LevelFeeling(
            ...
            new Distribution(1, 25), new Distribution(10, 19), false, 1, 6);
    public static final LevelFeeling BURNED = new LevelFeeling(
            ...
            new Distribution(1, 29), new Distribution(4, 7), false, 1, 6);
